...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0dczl2s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0dczl2s.containers.anotherwebservice.com/
...
```
git clone git@github.com:zarket410/container-0dczl2s.git
cd container-0dczl2s
```
...
```
docker attach container-0dczl2s
```
